...
<template>
    <Modal :openModal="openModal" :data="selectedCompany" @check="toggleModal" @submitForm="updateCompany" />
    ...
    <div class="flex  flex-col justify-center px-6 py-12 lg:px-8 w-full ">
        <div class="flex justify-between">
            ...
            <button @click="openModal2 = true" type="button"
        ...
        <div v-if="companies.data?.length !== 0" class="grid grid-cols-1 md:grid-cols-4 gap-5 px-4 mt-8  sm:px-8 bg-gray-50 rounded-xl shadow-md " style="padding: 20px;">
